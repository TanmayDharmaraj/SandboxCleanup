...
namespace SandboxCleanup
{
    class Program
    {
        ...
        private static void CleanFeatures(string manifest_path)
        {
        ...
        {
            string root_destination_folder = @"C:\Users\TanmayD\Downloads\Sandbox\AdHoc\Extracted";
            string cab_destination_folder = @"C:\Users\TanmayD\Downloads\Sandbox\AdHoc\Converted";
            string[] sandbox_solution_paths = new string[] {
                @"C:\Users\TanmayD\Downloads\Sandbox\AdHoc\RapidCircle.SharePoint.Responsive.Server.wsp"
            };
            ...
            foreach (string sandbox_path in sandbox_solution_paths)
            {
                ...
                CleanFeatures(Path.Combine(extracted_folder, "manifest.xml"));
